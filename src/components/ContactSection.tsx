            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Input
                    ...
                    className="bg-white border-gray-300 text-black placeholder:text-gray-400 focus:border-orange focus:ring-orange disabled:opacity-50"
                  />
                </div>
                <div>
                  <Input
              ...
              <div>
                <Textarea
                  ...
                  rows={10}
                  disabled={isSubmitting}
                  className="bg-white border-gray-300 text-black placeholder:text-gray-400 focus:border-orange focus:ring-orange resize-none disabled:opacity-50"
                />
              </div>
